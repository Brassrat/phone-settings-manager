 ...
 */
public class ScheduleListAdapter extends ListAdapter<ScheduleEntry>
{
  ...
  public View getView(int position, View convertView, ViewGroup parent)
  {
    ...
    ScheduleEntry schedule = getItem(position);
    ...
    {
      scheduleView = new ScheduleView(context, schedule);
    }
