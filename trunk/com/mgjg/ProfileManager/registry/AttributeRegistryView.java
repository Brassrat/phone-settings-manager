...
public final class AttributeRegistryView<T extends Viewable<T>> extends LinearLayout
{
  ...
  public static final LinearLayout.LayoutParams paramsFillWrap = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
  ...
  public AttributeRegistryView<T> copyToView(Context context, T aAttr)
  {
    ...
    if (!attr.copy(aAttr))
    {
      return new AttributeRegistryView<T>(context, aAttr);
    }
    return this;
  }
